...
export default function ContactSection() {
  return (
    <Box>
      <Box
        sx={{ width: { xs: "95%", sm: "90%", md: "80%" }, margin: "5% auto" }}
      >
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              ...
              >
                ...
                <Typography
                  variant="body2"
                  sx={{ color: "#222831", padding: "4px  14px" }}
                >
                  25/B Milford Elm Drive Road,
                  <br />
                  New York, USA
                </Typography>
              </Box>
              ...
              >
                ...
                <Typography
                  ...
                  sx={{ color: "#222831", padding: "4px  14px" }}
                >
                  +2 123 4565 788 <br /> +2 123 4565 789
                </Typography>
              </Box>
              <Box
                sx={{
