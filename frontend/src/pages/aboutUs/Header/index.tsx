...
export default function HeaderAboutUs(){
    return(
        <Box sx={{backgroundColor:"#fff"}}>
            ...
            <Box sx={{width:{xs:"98%" , md:"80%"} , mx:"auto" , py:{xs:4 , md:8} , mt:5 , backgroundColor:"#22A396" , borderRadius:2}}>
                <Grid container spacing={3} justifyContent="center" alignItems="center">
                    {counters.map((item, idx) => (
                    <Grid item xs={6} sm={6} md={3} key={idx}>
                        <Box sx={{display:"flex" , flexDirection:"column" , alignItems:"center" , color:"white" , px:2}}>
                        <Box sx={{backgroundColor:"#04354b" , border:"2px solid white" , borderRadius:"50%" , height:75 , width:75 , display:"flex" , alignItems:"center" , justifyContent:"center" , mb:2}}>
                        {item.icon}
                        </Box>
