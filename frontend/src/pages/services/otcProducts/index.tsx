    ...
    return (
        <Box>
            <Box>
                <BackgroundImage imageUrl="/ServicesBG.png" css={{height:"400px" , width:"100%" , objectFit:"cover"}}>
                    ...
                    <Box sx={{width:"80%" , margin:"auto", padding:"20px"}}>
                        ...
                        <Typography variant="h5" sx={{color:"#023350"}}>Home &gt;&gt; Services &gt;&gt; OTC Products</Typography>
                    </Box>
                </BackgroundImage>
            </Box>
            ...
            <Container maxWidth="xl" sx={{width:"80%", padding:"15px", margin:"auto"}}>
                <Box>
                    <Typography variant="h4" sx={{color:"#023350" , fontWeight:"700",mb:3}}>OTC <span style={{color:"#03A297",fontWeight:"700"}}>Products</span></Typography>
